...
import { InfoIcon, CreditCardIcon, AlertTriangleIcon } from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogFooter className="gap-2">
          ...
          <Button 
            onClick={onConfirm} 
            disabled={isLoading || !input.amount || parseFloat(input.amount) <= 0 || parseFloat(input.amount) > maxWithdrawAmount}
          >
